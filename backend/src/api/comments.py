...
async def add_comment(
    ...
    comment = await service.add(body=payload.body, article_id=id, author_id=current_user_id)
...
async def delete_comment(
    ...
    if comment.author_id != current_user_id and article.author_id != current_user_id:
